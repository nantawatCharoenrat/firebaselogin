...
class EditCatPage1 extends StatefulWidget {
  final String _idi;
  const EditCatPage1(this._idi, {Key? key}) : super(key: key);

  @override
  _EditCatPage1State createState() => _EditCatPage1State();
}

class _EditCatPage1State extends State<EditCatPage1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('edit แมววิเชียรมาศ'),
      ),
      body: Form(
        key: _form,
        child: ListView(
    ...
    return ElevatedButton(
        ...
        onPressed: () async {
          if (_form.currentState!.validate()) {
            ...
            try {
              var collection = FirebaseFirestore.instance.collection('cat1');
              collection
                  .doc(id)
              ...
              deleteAll();
              Navigator.popUntil(context, ModalRoute.withName('/catpage1'));
            } catch (e) {
